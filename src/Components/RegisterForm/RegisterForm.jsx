...
function RegisterForm() {
    ...
    const postData = async () => {
        ...
        await axios.post('http://localhost/raseem/data-operations.php', inputs).then(function (response) {
                    ...
                    <div className="flex-c pad-20 flex-centered">
                        ...
                        <form onSubmit={hundleSubmit} className="flex-c fill pad-5">
                            ...
                            <div className="flex pad-20 flex-centered">
                                <button type='submit' className="btn-pri-o pad-10 width-50">SUBMIT</button>
                            </div>
                        </form>
                    </div>
                }
